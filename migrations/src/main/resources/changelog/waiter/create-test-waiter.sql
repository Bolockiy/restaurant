...
VALUES
    (1001, 'CREATED', NOW(), 1, 'A1'),
    (1002, 'CREATED', NOW(), 2, 'B3');

-- 4. Позиции заказов
INSERT INTO order_positions (composition_id, dish_num, order_no, menu_position_id)
VALUES
    (1, 2, 1001, 1), -- 2 салата Цезарь для заказа 1001
    (2, 1, 1001, 2), -- 1 Борщ для заказа 1001
    (3, 1, 1002, 3), -- 1 Стейк Рибай для заказа 1002
    (4, 2, 1002, 5); -- 2 чая для заказа 1002
